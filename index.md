...
As I started my program of Computer Science, my goals have shifted considerably. In the past, I aspired of getting out the Army to go into programming as my new career. This goal has shifted due to the additional knowledge on the field of Computer Science as a whole. Moving forward developing my ePortfolio I reliaze the extent of my strengths in Computer Science. I have strengths in CS categories such as collaborating in a team environment, communicating to stakeholders, data structures and algorithms, software engineering and database,
